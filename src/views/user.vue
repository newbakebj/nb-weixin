...
<div class="content user">
  ...
  <nav class="bar bar-tab user-tab">
    ...
    <router-link class="tab-item" to="/user/withdraw">
  ...
  <div class="list-block user-list">
    <ul>
      <li>
        <router-link class="item-content item-link" to="/user/profile">
    ...
    <ul>
      <li>
        <router-link class="item-content item-link" to="/user/tasks">
          <div class="item-media"><span class="icon icon-star"></sapn></div>
          <div class="item-inner">
    ...
    <ul>
      <li>
        <router-link class="item-content item-link"  to="/user/profit">
        <div class="item-media"><span class="icon icon-star"></sapn></div>
        <div class="item-inner">
    ...
    <ul>
      <li>
        <router-link class="item-content item-link"  to="/user/profit/record">
        <div class="item-media"><span class="icon icon-star"></sapn></div>
        <div class="item-inner">
    ...
    <ul>
      <li>
        <router-link class="item-content item-link"  to="/invite">
        <div class="item-media"><span class="icon icon-star"></sapn></div>
        <div class="item-inner">
